 ...
 * 
 */
@WebServiceClient(name = "wsBanco", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/WSBanco/wsBanco?WSDL")
    ...
    extends Service
{
    ...
    private final static QName WSBANCO_QNAME = new QName("http://ws/", "wsBanco");
    ...
    public WsBanco getWsBancoPort() {
        return super.getPort(new QName("http://ws/", "wsBancoPort"), WsBanco.class);
    }
    ...
    public WsBanco getWsBancoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "wsBancoPort"), WsBanco.class, features);
    }
