 ...
 * 
 */
@WebServiceClient(name = "WSLOGIN", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/Login/WSLOGIN?WSDL")
    ...
    extends Service
{
    ...
    private final static QName WSLOGIN_QNAME = new QName("http://ws/", "WSLOGIN");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Login/WSLOGIN?WSDL");
    ...
    public WSLOGIN getWSLOGINPort() {
        return super.getPort(new QName("http://ws/", "WSLOGINPort"), WSLOGIN.class);
    }
    ...
    public WSLOGIN getWSLOGINPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "WSLOGINPort"), WSLOGIN.class, features);
    }
